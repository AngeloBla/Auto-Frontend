      ...
      <>
        ...
        <div className="row featurette">
          ...
          <div className="col-md-5 order-md-1">
            <img
              src="https://lego-defender-model-s3bucket.s3.eu-central-1.amazonaws.com/bilder/landrover_web_rundum/landrover_hfs.jpg"
              alt="Bildbeschreibung"
              className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
              width="500"
              height="500"
        ...
        <div className="row featurette">
          ...
          <div className="col-md-5">
            <img
              src="https://lego-defender-model-s3bucket.s3.eu-central-1.amazonaws.com/bilder/landrover_web_rundum/landrover_vfs.jpg"
              alt="Bildbeschreibung"
              className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
              width="500"
              height="500"
