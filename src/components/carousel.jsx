    ...
    render() { 
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img src="https://lego-defender-model-s3bucket.s3.eu-central-1.amazonaws.com/bilder/landrover_web_rundum/landrover_fs.jpg" className="d-block w-100 img-fluid" alt="..."/>
          </div>
          <div className="carousel-item">
