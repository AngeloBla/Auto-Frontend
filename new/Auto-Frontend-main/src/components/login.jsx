  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      if (accessToken) {
        ...
        if (userGroups) {
          if (userGroups.includes("Lager")) {
            // Lager-Mitarbeiter, leite zur Lagerseite weiter
            navigate('/lager');
          } else if (userGroups.includes("Konstruktion")) {
            // Konstruktions-Mitarbeiter, leite zur Konstruktionsseite weiter
            navigate('/dashboard');
          } else {
            // Andere Gruppen oder keine Gruppen, leite zur Startseite weiter
            navigate('/');
          }
        }
      }
