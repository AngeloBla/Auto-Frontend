    ...
    <p align="center" style="color:red; font-weight:bold">!-!-! Work in Progress !-!-!</p>
        ...
        <div className="zahlungsmethode">
            ...
            <div className="single-model-search">
                <div className="toggle-button" onclick="toggleElements()">
                    ▼ Zahlungsoptionen
                </div>
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <select className="form-select" id="hoodColor" onchange="loadHoodImage()">
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <select className="form-select" id="roofColor" onchange="loadRoofColorImage()">
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <select className="form-select" id="roofrack" onchange="loadroofrackImage()">
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <select className="form-select" id="windowcolor" onchange="loadwindowcolorImage()">
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <div className="form-control" id="service">
                    <label>
                        <input type="checkbox" className="from-control" id="wartung_verschleiss" value="wartung_verschleiss">
                        Wartung & Verschleiß
                    </label>
                        <input type="checkbox" className="from-control" id="ueberfuehrung" value="ueberfuehrung">
                        Überführungskosten
                    </label>
                        <input type="checkbox" className="from-control" id="kfz_versicherung" value="kfz_versicherung">
                        KFZ-Versicherung
                    </label>
                        <input type="checkbox" className="from-control" id="zulassungsservice" value="zulassungsservice">
                        Zulassungsservice
                    </label>
                        <input type="checkbox" className="from-control" id="mobilitaetsgarantie" value="mobilitaetsgarantie">
        ...
        <div className="single-model-search">
            ...
            <div className="model-select-icon">
                <div id="zusatz" className="form-control">
                    <label>
                        <input type="checkbox" className="form-control zusatz-option" id="hitch" value="hitch"> 
                        Anhängevorrichtung, 13 polig
                    </label>
                    <label>
                        <input type="checkbox" className="form-control zusatz-option" id="underbody-protection" value="underbody-protection"> 
                        Unterbodenschutz auf Wachsbasis
                    </label>
                    <label>
                        <input type="checkbox" className="form-control zusatz-option" id="mudguard" value="mudguard"> 
                        Spritzschutz
                    </label>
                </div>
            </div>
