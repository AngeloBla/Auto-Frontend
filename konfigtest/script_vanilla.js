    ...
    loadPrices();
        ...
        // ########### Funktion Zahlung ENDE ##########
                ...
                document.querySelector(document).ready(function () {
                    ...
                    document.querySelector('#reifen input[type="checkbox"]').addEventListener('change', function() {
                        updateOptions(document.querySelector(this));
                    ...
                    ganzjahresCheckbox.addEventListener('change', function() {
...
document.querySelector('.zusatz-option').addEventListener('change', function() {
    // Ihre Logik für zusätzliche Optionen
});

// Event Listener für zusätzliche Optionen
document.querySelector('.service-option').addEventListener('change', function() {
    // Ihre Logik für zusätzliche Optionen
});

// Event Listener für Service-Checkboxen
document.querySelector('#service input[type="checkbox"]').addEventListener('change', function() {
